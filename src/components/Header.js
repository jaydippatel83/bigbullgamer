...
function Header() {
  ...
  return (
    <div className="nav-header bg-white shadow-xs border-0" style={{backgroundColor:'#000000'}}>
      ...
      <div className="ms-auto ml-auto">
        ...
        <a 
          ...
          target="_blank"
          style={{border:'none'}} className="p-2 bg-gold-gradiant me-2 text-white text-center font-xssss fw-600 ls-1 rounded border-none"
        >
          Gameverse
        </a>
      </div>   
      <button  variant="primary" onClick={() => gameverse()}>
              ...
              <ul className="mb-1 top-content">
                ...
                >
                  ...
                  <ListItemButton onClick={() => navigatePages("/defaultbadge")}>
                    ...
                    <ListItemText className="fw-700  h4" primary="Tournaments" />
                  </ListItemButton> 
