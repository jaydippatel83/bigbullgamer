...
export default function CreatePostModal() {
    ...
    return (
        <div>
            <ToastContainer />
            <button style={{border:'none'}} className="p-2 bg-gold-gradiant me-2 text-white text-center font-xssss fw-600 ls-1 rounded border-none" variant="primary" onClick={() => setShow(true)}>
                Create Post
            </button>
